...
@patch.dict(os.environ, {"AIRFLOW__COSMOS__ENABLE_START_FROM_TRIGGER": "False"}, clear=True)
def test_enable_start_from_trigger_env_var():
    reload(settings)
    assert settings.enable_start_from_trigger is False
